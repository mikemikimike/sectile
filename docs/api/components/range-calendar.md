...
description: Choose an inclusive date range directly in an always-visible calendar grid.
---
...
[Back to Range Calendar usage and examples](/components/range-calendar)
