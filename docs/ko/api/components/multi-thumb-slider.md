---
title: Multi Thumb Slider API
description: 하나의 수치 트랙에서 순서가 있는 여러 값을 조절합니다.
---
<!-- scripts/generate-component-pages.mjs에서 생성함. -->
# Multi Thumb Slider API

하나의 수치 트랙에서 순서가 있는 여러 값을 조절합니다.

이 페이지는 정확한 공개 계약을 찾기 위한 레퍼런스입니다. 실제 구성과 스타일링은 사용 예시에서 시작하세요.

[Multi Thumb Slider 사용 예시로 돌아가기](/ko/components/multi-thumb-slider)
